...
using FP.Patterns.Memento.Exercice3;

TaskManager taskManager = new();

// Adding tasks
taskManager.AddTask(new ETask(1, "Implement Memento Pattern", "In Progress"));
taskManager.AddTask(new ETask(2, "Update ETaskManager UI", "Pending"));
taskManager.AddTask(new ETask(3, "Test TaskManager Class", "Completed"));
